...
peer lifecycle chaincode commit -o orderer.example.com:30081 --tls  --cafile /tmp/tlsca.example.com-cert.pem --channelID $CHANNEL_ID --name basic --version 1.0 --signature-policy $NEW_POLICY --sequence $NEXT_SEQUENCE