...
mint_command="{\"function\":\"TransferFrom\",\"Args\":[\"x509::CN=User1@peer403.kubernetes.research.dev.example.com,OU=client,L=Bretten,ST=Baden,C=DE::CN=ca.peer403.kubernetes.research.dev.example.com,O=peer40
